...
public class Estado {
    ...
    public static Estado addEstado() {
        ...
        panel.add(new JLabel("Selecione o Estado:")); // título dentro do painel
        panel.add(comboBox);
        ...
        int result = JOptionPane.showConfirmDialog(
                null,
                panel,
                "Escolha de Estado", // título da janela
                JOptionPane.OK_CANCEL_OPTION,
                JOptionPane.QUESTION_MESSAGE,
                icone // ícone da janela
        );
    ...
    public static Estado editEstado() {
        // Criar combo box
        JComboBox<String> comboBox = new JComboBox<>(SIGLAS_ESTADOS);
        comboBox.setSelectedIndex(0); // Nenhuma opção selecionada inicialmente
